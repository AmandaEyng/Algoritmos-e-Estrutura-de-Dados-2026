...
public class ListaEstatica {
	...
	public void retirar(int valor) {
	    ...
	    // Adicione esta condição para só remover se encontrar o elemento
	    if (indiceRemover != -1) {
	...
	public int obterElemento(int posicao) {
		if (posicao < 0 || posicao >= tamanho) { // Correção: >= tamanho
	...
	public String toString() {
	    ...
	    for (int i = 0; i < tamanho; i++) {
	        s += info[i];
	        // Só adiciona a vírgula e o espaço se NÃO for o último elemento
	        if (i < tamanho - 1) {
	            s += ", "; 
	        }
	    }
